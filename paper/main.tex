...
\begin{figure*}
    ...
    For each plot, the parameters are set to $U=-2.5t$ and $N_\gamma = 6000$, while $V$ is varied according to the text in the individual panels.
...
\begin{figure*}
    ...
    The shaded area marks the two-particle continuum.
    For each plot, the parameters are set to $U=-2.5t$, $V=0$, and $N_\gamma = 6000$.
...
\begin{figure*}
    ...
    The left column shows the results for the square lattice while the right column shows the results for the simple cubic lattice.
    The shaded area marks the two-particle continuum.
    For each plot, the parameters are set to $V=1t$ and $N_\gamma = 6000$, while $U$ is varied according to the text in the individual panels.
