...
Moving towards smaller $V$, the peaks move toward greater $\omega$, i.e., closer to the two-particle continuum.
Additionally, the weights drop off, first with increasing speed and then slowing down.
They seem to converge toward some value, but we are unable to compute the Green's functions for additional, 
