...
\begin{subequations}
    ...
    \begin{align}
        A_\text{Higgs} &= \frac{1}{N} \sum_{\vk} \left( f_{\vk} + f_{\vk}^\dagger \right) \,,\\
        A_\text{Phase} &= \frac{i}{N} \sum_{\vk} \left( f_{\vk} - f_{\vk}^\dagger \right) \,,\\
        A_\text{CDW} &= \frac{1}{N} \sum_{\vk} \left( g_{\vk \up} + g_{\vk \down} \right) \,,\\
        A_\text{AFM} &= \frac{1}{N} \sum_{\vk} \left( g_{\vk \up} - g_{\vk \down} \right) \,,
    \end{align}
\end{subequations}
