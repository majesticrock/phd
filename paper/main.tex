...
Collective excitations hold profound scientific interest as they unveil the intricate dynamics of correlated electron systems, 
offering key insights into the emergent properties of materials.
...
\begin{figure}
    ...
    The green shading shows the region that we cannot access because it the discretization $N_\gamma$, which is required to accurately describe the system, is too large.
