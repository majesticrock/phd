...
Since the degeneracy of both phases is exact due to the SO(4) symmetry \cite{yang90}, 
there should not be any difference between $\spectral{Higgs}$ and $\spectral{CDW}$ as both spectral functions capture the amplitude fluctuations of their respective order parameters.
...
Moving further away from the phase transition, here $U=z(V+0.2t)$ in panels (c) and (d), the upper peak becomes soft as it shifts into the quasiparticle continuum. 
