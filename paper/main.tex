...
Since the degeneracy of both phases is exact \textcolor{red}{Zitat}, there should not be any difference between $\spectral{Higgs}$ and $\spectral{CDW}$ as both spectral functions capture the amplitude fluctuations of their respective order parameters.
...
$\spectral{CDW}$ shows a peak below the continuum only in the SC phase corresponding to the finite energy necessary to excite this kind of electronic density modulation.
For moderate-sized values of $V>0$, i.e., in the CDW phase, see panel (c) at $V=0.1t$, the aforementioned spectral function has a peak at $\omega=2\Delta_\text{CDW}$.
This peak becomes hard and moves outside the two-particle continuum as $V$ is increased, see panel (d) at $V=0.5t$.
