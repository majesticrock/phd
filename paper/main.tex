...
\begin{figure*}
    ...
    The panels (a) and (b) show the spectral functions in the SC and CDW phases, respectively.
    The parameters are set to $U=-2.5t$, $V=\pm0.1t$, and $N_\gamma = 3000$.}
...
\begin{figure*}
    ...
    The parameters are set to $U=zV \pm 0.1t$, $V=1t$, and $N_\gamma = 3000$.}
    \label{fig:resolvent_overview_AFM}
\end{figure*}

To begin, let us describe the spectral functions $\mathcal{A}(\omega) = - (1/\pi) \Im [\mathcal{G} (\omega + i0^+)]$ with respect to the operators above in the various phases.
A plot of them in the SC and CDW phase, close to the phase transition, is shown in \autoref{fig:resolvent_overview_SC}.
...
\begin{figure}
    ...
    \caption{Log-log plot of the real part of the $A_\text{Phase}$ Green's function in the SC phase at $U=-2.5t$ and $V=-0.1t$ as well as a linear fit to it.
...
\begin{figure}
    ...
    \caption{Log-log plot of the $A_\text{Higgs}$ spectral function near $\omega = \omega_0 = 2\Delta_\text{SC}$ in the SC phase at $U=-2.5t$ and $V=-0.1t$..
...
Firstly, the real part of the $A_\text{Phase}$ Green's function is shown in \autoref{fig:phase_peak}.
...
Continuing, we investigate the divergence at $\omega = 2\Delta$ found in the $A_\text{Higgs}$ spectral function within the SC phase.
...
The $A_\text{AFM}$ and $A_\text{CDW}$ peaks close the the phase transition are identical when swapped, i.e., $\mathcal{A}_\text{AFM} (\omega)$ in the CDW phase is the same as $\mathcal{A}_\text{CDW} (\omega)$ in the AFM phase.
