...
They are depicted in \autoref{fig:resolvent_overview_AFM}, choosing $V=1$ for the square lattice and $V=0.5$ for the simple cubic lattice.
For the CDW phase (panel a) we chose $V=4.1$ and for the AFM phase (panel b) $V=3.9$.
