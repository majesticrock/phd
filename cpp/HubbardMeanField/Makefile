...
HBBRD_SRCS=Model.cpp ModelModesV1.cpp BasicHubbardModel.cpp HubbardCDW.cpp UsingBroyden.cpp
UTIL_SRCS=InputFileReader.cpp OutputWriter.cpp Roots_Broyden.cpp Resolvent.cpp

PART_SRCS=
SRCS=$(addprefix Utility/, $(UTIL_SRCS)) $(addprefix Hubbard/, $(HBBRD_SRCS)) $(addprefix SymbolicCommute/, $(HBBRD_SRCS)) $(PART_SRCS) Hubbard_Mean_Field.cpp
