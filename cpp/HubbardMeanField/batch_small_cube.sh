...
for NEW_VALUE in "${NEW_VALUES[@]}"; do
  ...
  sed -i "s|mpirun ./build_cluster/HubbardMeanField params/small_cube.config|mpirun ./build_cluster/HubbardMeanField small_cube_auto_generated/$NEW_NAME.config|" small_cube_auto_generated/$NEW_NAME.slurm
