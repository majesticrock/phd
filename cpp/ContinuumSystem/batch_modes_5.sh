...
for NEW_VALUE in "${NEW_VALUES[@]}"; do
  ...
  sed -i "s|#SBATCH --output=/home/althueser/phd/cpp/ContinuumSystem/modes_output.txt|#SBATCH --output=/home/althueser/phd/cpp/ContinuumSystem/output_$NEW_NAME.txt|" auto_generated_5/$NEW_NAME.slurm
