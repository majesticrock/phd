...
for NEW_VALUE in "${NEW_VALUES[@]}"; do
  ...
  sed -i "s|mpirun ./build/ContinuumSystem params/ul_cluster.config|mpirun ./build/ContinuumSystem auto_generated_ul_3/$NEW_NAME.config|" auto_generated_ul_3/$NEW_NAME.slurm
