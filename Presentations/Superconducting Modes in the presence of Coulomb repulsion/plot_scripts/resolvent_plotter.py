...
class HeatmapPlotter:
    ...
    def plot(self, cmap='viridis'):
        self.fig, self.axes = plt.subplots(nrows=2, sharex=True, figsize=(6.4, 6.4))
        ...
        contour = self.axes[0].contourf(self.x, self.y, spectral_functions_higgs, cmap=cmap, levels=levels, extend='max')
        _c1____ = self.axes[1].contourf(self.x, self.y, spectral_functions_phase, cmap=cmap, levels=levels, extend='max')
        ...
        self.axes[0].set_ylabel(r"$\omega [\mathrm{meV}]$")
        self.axes[1].set_ylabel(r"$\omega [\mathrm{meV}]$")
        ...
        self.axes[1].set_xscale(self.xscale)
        self.axes[0].set_yscale(self.yscale)
        self.axes[1].set_yscale(self.yscale)
