...
\posterbox{\boxmargin}{\dimexpr\firstbox + 53.2cm}{\boxwidth}{Method: Iterated equations of motion (iEoM) \cite{Kalthoff17,Bleicker18}}
{%
...
\posterbox{\boxmargin}{109.7cm}{\boxwidth}{Possible outlook}
{%
\begin{itemize}
