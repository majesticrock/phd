...
\posterbox{\boxmargin}{\dimexpr\firstbox + 53.2cm}{\boxwidth}{Method: Iterated equations of motion (iEoM)}
{%
...
\posterbox{ \boxwidth + \boxmargin + \boxmargin}{\dimexpr\firstbox + 52cm}{\boxwidth}{Behavior of the peaks}
{%
...
\posterbox{\boxmargin}{109.77cm}{\boxwidth}{Possible outlook}
{%
\begin{itemize}
...
\posterbox{\boxwidth + \boxmargin + \boxmargin}{110.4cm}{\boxwidth}{References}
{%
\begingroup
